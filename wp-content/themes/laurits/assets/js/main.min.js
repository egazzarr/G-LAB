! function(n) {
    ...
    window.qodef = {}, qodef.body = n("body"), qodef.html = n("html"), qodef.window = n(window), qodef.windowWidth = n(window).width(), qodef.windowHeight = n(window).height(), qodef.scroll = 0, n(document).ready(function() {
        qodef.scroll = n(window).scrollTop(), i.init(), y.init(), o.init(), s.init(), a.init()
    ...
    }), n(document).on("laurits_trigger_get_new_posts", function() {
        y.init(), o.init()
    });
    var i = {
            init: function() {
        ...
        y = {
            ...
            getOptions: function(e, t) {
                var i = void 0 !== e.data("options") ? e.data("options") : {},
                    ...
                    c = void 0 !== i.slideAnimation && "" !== i.slideAnimation ? i.slideAnimation : "",
                ...
                var q = void 0 !== i.slidesPerView1440 && "" !== i.slidesPerView1440 ? parseInt(i.slidesPerView1440, 10) : 5,
                    ...
                    w = void 0 !== i.slidesPerView1024 && "" !== i.slidesPerView1024 ? parseInt(i.slidesPerView1024, 10) : 3,
                    u = void 0 !== i.slidesPerView768 && "" !== i.slidesPerView768 ? parseInt(i.slidesPerView768, 10) : 2,
                    l = void 0 !== i.slidesPerView680 && "" !== i.slidesPerView680 ? parseInt(i.slidesPerView680, 10) : 1;
                h || (n < 2 ? u = w = v = q = n : n < 3 ? w = v = q = n : n < 4 ? v = q = n : n < 5 && (q = n));
                n = {
                    slidesPerView: n,
                    centeredSlides: a,
                    sliderScroll: s,
                ...
                return c.length && "fade" === c && (n.effect = "fade", n.fadeEffect = {
                    crossFade: !0
                }), e.closest(".qodef-portfolio-list.qodef-item-layout--image-slider") && e.hasClass("qodef--slider") && (n.effect = "fade", n.fadeEffect = {
                    crossFade: !0
                }, n.allowTouchMove = !1), Object.assign(n, y.getSliderDatas(e))
            },
            ...
            getEvents: function(i, e) {
                return {
                    on: {
                        init: function() {
                            var t;
                            i.addClass("qodef-swiper--initialized"), qodef.body.trigger("laurits_trigger_swiper_is_initialized", [i, e]), e.sliderScroll && (t = !1, i.on("mousewheel", function(e) {
    ...
    var a = {
        init: function() {
            var e = n("body.search.search-no-results, body.error404");
            e.length && e.each(function() {
                let e = n(this),
                    t = e.find("#qodef-page-outer"),
                    i = e.find("#qodef-page-footer").height();
                var o;
                1024 < qodef.windowWidth ? (e.headerHeight = a.getHeaderHeight(), t.height(qodef.windowHeight - e.headerHeight - i)) : qodef.windowWidth <= 768 && 680 < qodef.windowWidth ? (o = e.find("#qodef-page-mobile-header").height(), t.height(qodef.windowHeight - o - i)) : t.css("height", "auto")
            })
        },
        getHeaderHeight: function() {
            var e = 0;
    ...
    qodef.qodefFullScreenPage = a;
    const r = {
        init() {
            this.elements = n(".qodef-custom-svg-line, .qodef-custom-svg-long-line, .qodef-custom-svg-circle, .qodef-custom-svg-letter, .qodef-custom-column-appear, .qodef-custom-column-elements-appear"), this.elements.length && this.elements.each((e, t) => {
                t = n(t);
                r.appearAnimation(t)
            })
        },
    ...
    qodef.qodefAppearAnimation = r;
    const e = {
        init() {
            this.elements = n(".qodef-custom-zoom-image > div, .qodef-zoom-scroll-animation--yes img"), this.elements.length && (this.elements.each((e, t) => {
                const i = n(t);
                i.offset().top, i.height();
                i.closest(".qodef-info-section"), i.attr("data-parallax", '{"scale": 1.2, "smoothness": 60, "easing": "easeOutQuart"}')
            }), e.initItems())
        },
        initItems() {
    ...
    qodef.qodefZoomScrollEffect = e, "function" != typeof Object.assign && (Object.assign = function(e) {
...
function(o) {
    ...
    o(document).ready(function() {
        ...
        n.init()
    }), o(document).on("laurits_trigger_get_new_posts", function(e, t) {
    ...
    var s = {
        ...
        setVisibility: function(e, t) {
            ...
            a.additional_query_args = {
                tax_query: t
            }, qodef.body.trigger("laurits_trigger_load_more", [e, 1])
        },
...
function(r) {
    ...
    r(document).ready(function() {
        t.init()
    }), r(document).on("laurits_trigger_get_new_posts", function() {
        t.init()
    });
    var t = {
        init: function() {
...
function(t) {
    ...
    t(document).ready(function() {
        ...
        n.reInit()
    }), t(document).on("laurits_trigger_get_new_posts", function(e, t) {
...
function(a) {
    ...
    a(document).ready(function() {
        ...
        s.scroll()
    }), a(document).on("laurits_trigger_load_more", function(e, t, i) {
    ...
    var s = {
        ...
        getNewPosts: function(t, i) {
            ...
            s.setNextPageValue(n, i, !1), a.ajax({
                ...
                success: function(e) {
                    "success" === e.status ? (n.max_pages_num !== e.data.max_pages_num && (n.max_pages_num = e.data.max_pages_num), s.setNextPageValue(n, i, !0), s.changeStandardHtml(t, n.max_pages_num, i, e.data.pagination_html), o.waitForImages(function() {
                        s.addPosts(o, e.data.html, i), s.reInitMasonryPosts(t, o), setTimeout(function() {
                            qodef.body.trigger("laurits_trigger_get_new_posts", [t, e.data, i])
                        }, 300)
        ...
        addPosts: function(e, t, i) {
            void 0 !== i && "" !== i ? (e.html(t), e.parent().hasClass("qodef-layout--masonry") && e.append('<div class="qodef-grid-masonry-sizer"></div><div class="qodef-grid-masonry-gutter"></div>')) : e.append(t)
        },
...
function(d) {
    ...
    d(document).ready(function() {
        i.init(), e.init(), t.init(), n.init(), o.init()
    });
    var i = {
            init: function(e) {
    ...
    var o = {
        init() {
            const e = d(".qodef-woo-product-list");
            e.length && e.each((e, t) => {
                const i = d(t);
                if (!i.parent(".related.products").length) {
                    let o = 0;
                    i.find(".product").each((e, t) => {
                        const i = d(t);
                        i.outerHeight() > o && (o = i.outerHeight())
                    }), i.find(".product").height(o)
                }
            })
        }
    };
    qodef.qodefWooDefaultProductHeight = o;
    const n = {
        init() {
            const e = d(".qodef-woo-product-list.qodef-item-layout--info-below");
            e.length && e.each((e, t) => {
                const i = d(t);
                i.hasClass("qodef-hover-animation--yes") && n.initEffect(i)
            })
        },
        initEffect(e) {
            const t = e.find(".qodef-woo-product-image a");
            t.length && t.each((e, t) => {
                const i = d(t);
                i.on("mouseover", function() {
                    d(this).children("img").css({
                        transform: "scale(1.6)"
                    })
                    ...
                    d(this).children("img").css({
                        "transform-origin": (e.pageX - d(this).offset().left) / d(this).width() * 100 + "% " + (e.pageY - d(this).offset().top) / d(this).height() * 100 + "%"
                    })
                })
            })
        }
    };
    qodef.qodefWooHoverZoomEffect = n
}(jQuery);